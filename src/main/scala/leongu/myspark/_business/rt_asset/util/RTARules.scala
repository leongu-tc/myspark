...
object RTARules extends RTACons {
  ...
  /**
    ...
    */
  def stk_compute(bsflag: String, stkbal: Array[Byte], matchqty: Long): Long = {
    var ret = Bytes.toLong(stkbal)
    bsflag match {
      case "03" | "0B" | "0a" | "0b" | "0c" | "0d" | "0e" | "0q" | "1j" | "3m" => ret += matchqty
      case "04" | "0S" | "0f" | "0g" | "0h" | "0i" | "0j" | "0r" | "3n" => ret += matchqty
    }
    ret
  }
